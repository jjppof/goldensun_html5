...
import {Button,ControllerButton} from "./XGamepad";
...
export class Hero extends ControllableChar {
    ...
    check_control_inputs() {
        ...
        if (!this.ice_sliding_active) {
            ...
            else if (this.data.gamepad.is_down(ControllerButton.LS)) this.stick_dashing = true; // Can't `!this.stickdashing;` since called at every frame
