...
export function initialize_interactable_objs_data(game, interactable_objects_db, load_promise_resolve) {
    ...
    for (let interactable_objects_key in interactable_objects_db) {
        ...
        sprite_base.setActionSpritesheet(iter_obj_data.key_name, iter_obj_data.spritesheet.image, iter_obj_data.spritesheet.json);
        sprite_base.setActionDirections(iter_obj_data.key_name, iter_obj_data.actions.animations, iter_obj_data.actions.frames_count);
