...
export class EventActivationEvent extends GameEvent {
    ...
    constructor(game, data, active, key_name, keep_reveal, keep_custom_psynergy, event_label, activate) {
        super(game, data, event_types.EVENT_ACTIVATION, active, key_name, keep_reveal, keep_custom_psynergy);
