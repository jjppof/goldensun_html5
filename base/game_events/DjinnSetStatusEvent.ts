...
export class DjinnSetStatusEvent extends GameEvent {
    ...
    constructor(game, data, active, key_name, keep_reveal, keep_custom_psynergy, djinn_key, status_key) {
        super(game, data, event_types.DJINN_SET_STATUS, active, key_name, keep_reveal, keep_custom_psynergy);
