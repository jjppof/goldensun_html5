...
export class ShopMenu {
    ...
    constructor(game: Phaser.Game, data: GoldenSun) {
        ...
        this.item_price_win = new Window(
            this.game,
            ITEM_PRICE_WIN_X,
            ITEM_PRICE_WIN_Y,
            ITEM_PRICE_WIN_WIDTH,
            ITEM_PRICE_WIN_HEIGHT
        );
        this.your_coins_win = new Window(
            this.game,
            YOUR_COINS_WIN_X,
            YOUR_COINS_WIN_Y,
            YOUR_COINS_WIN_WIDTH,
            YOUR_COINS_WIN_HEIGHT
        );
        this.item_desc_win = new Window(
            this.game,
            ITEM_DESC_WIN_X,
            ITEM_DESC_WIN_Y,
            ITEM_DESC_WIN_WIDTH,
            ITEM_DESC_WIN_HEIGHT
        );

        this.buy_menu = new BuyArtifactsMenu(this.game, this.data, this);
        this.sell_menu = new SellRepairMenu(this.game, this.data, this);

        this.your_coins_label = this.your_coins_win.set_text_in_position(
            "Your Coins: ",
            YOUR_COINS_LABEL_X,
            YOUR_COINS_LABEL_Y
        );
        ...
        this.item_price_val_text = this.item_price_win.set_text_in_position(
            "",
        ...
        if (this.item_price_win.open && this.sell_menu.active) {
            ...
            if (itm) {
                ...
                this.update_item_info(
                    itm.key_name,
                    price_val,
                    is_repair ? !itm.broken : important_item,
                    is_repair ? itm.broken : true,
                    important_item
                );
            }
        }
