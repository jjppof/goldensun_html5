...
export class MainItemMenu {
    ...
    constructor(game:Phaser.Game, data:GoldenSun) {
        ...
        this.item_choose_window = new ItemPsynergyChooseWindow(this.game, this.data, false, this.item_change.bind(this));
    ...
    shift_item_overview(down:boolean, hide_sub_menus:boolean=true) {
        ...
        this.item_overview_window.update_size({height: ITEM_OVERVIEW_WIN_HEIGHT + (down ? ITEM_OVERVIEW_HEIGHT_SHIFT : 0)});
    ...
    char_choose() {
        if (this.choosing_give_destination) {
            if (this.data.info.party_data.members[this.selected_char_index].key_name === this.item_options_window.char.key_name) return;
        ...
        this.item_choose_window.grant_control(this.open_char_select.bind(this), () => {
