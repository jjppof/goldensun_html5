...
export class SellRepairMenu {
                ...
                this.yesno_action.open(
                    {
                        yes: () => {
                            ...
                            this.data.control_manager.addSimpleControls(this.on_item_repair.bind(this));
                        },
                        no: () => {
    ...
    open_menu(is_repair_menu: boolean, close_callback?: Function) {
        ...
        if (is_repair_menu) {
            ...
            this.data.control_manager.addSimpleControls(this.open_inventory_view.bind(this, "repair_select"));
