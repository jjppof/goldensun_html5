...
export class CursorManager{
    ...
    public init_tween(config:TweenConfig){
        ...
        switch(config.type){
            case CursorManager.WIGGLE.KEY:
                ...
                .to({ x: this.cursor.x + wiggle_x1, y: this.cursor.y + wiggle_y1 }, wiggle_time, Phaser.Easing.Linear.None)
                .to({ x: this.cursor.x + wiggle_x2, y: this.cursor.y + wiggle_y2 }, wiggle_time, Phaser.Easing.Linear.None)
                .to({ x: this.cursor.x + wiggle_x1, y: this.cursor.y + wiggle_y1 }, wiggle_time, Phaser.Easing.Linear.None)
                .to({ x: this.cursor.x, y: this.cursor.y}, wiggle_time, Phaser.Easing.Linear.None).loop();
                break;
            case CursorManager.POINT.KEY:
                ...
                .to({ x: this.cursor.x, y: this.cursor.y}, point_time, Phaser.Easing.Linear.None).loop();
        }
    ...
    public move_to(pos:{x:number, y:number}, params?:{animate?:boolean, flip?:boolean,
