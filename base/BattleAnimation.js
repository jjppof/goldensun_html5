export class BattleAnimation {
    ...
    //sprite_index: -2 is the target, -1 is the caster, 0... is the sprites_key_names index
    constructor(
        key_name,
        sprites_key_names,
        x_sequence, //{start_at: value, sprite_index: index, to: value, tween: type, duration: value}
        y_sequence, //{start_at: value, sprite_index: index, to: value, tween: type, duration: value}
        x_scale_sequence, //{start_at: value, sprite_index: index, to: value, tween: type, duration: value}
        y_scale_sequence, //{start_at: value, sprite_index: index, to: value, tween: type, duration: value}
        alpha_sequence, //{start_at: value, sprite_index: index, to: value, tween: type, duration: value}
        rotation_sequence, //{start_at: value, sprite_index: index, to: value, tween: type, duration: value, direction: value}
        stage_angle_sequence, //{start_at: value, to: value, tween: type, duration: value, direction: value}
        hue_angle_sequence, //{start_at: value, sprite_index: index, to: value, tween: type, duration: value, direction: value}
        tint_sequence, //{start_at: value, sprite_index: index, to: value, tween: type, duration: value}
        ...
        this.sprites_key_names = sprites_key_names;
