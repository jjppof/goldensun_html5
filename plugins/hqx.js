...
window.hqx = function( img, scale ) {
    ...
    var scaled = img;
    let gl = img.getContext('webgl');
    var origPixels = new Uint8Array(gl.drawingBufferWidth * gl.drawingBufferHeight * 4);
    gl.readPixels(0, 0, gl.drawingBufferWidth, gl.drawingBufferHeight, gl.RGBA, gl.UNSIGNED_BYTE, origPixels);
    ...
    var gl = scaled.getContext('webgl');
    var scaledPixelsData = new Uint8Array(gl.drawingBufferWidth * gl.drawingBufferHeight * 4);
    gl.readPixels(0, 0, gl.drawingBufferWidth, gl.drawingBufferHeight, gl.RGBA, gl.UNSIGNED_BYTE, scaledPixelsData);
    ...
    _src = src = null;
    _dest = dest = null;
    let image_data = new ImageData(new Uint8ClampedArray(scaledPixelsData), gl.drawingBufferWidth, gl.drawingBufferHeight);
